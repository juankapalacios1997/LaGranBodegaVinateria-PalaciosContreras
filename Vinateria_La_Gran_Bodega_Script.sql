...
-- -----------------------------------------------------
-- Table `vinateria_la_gran_bodega`.`Empleados`
-- -----------------------------------------------------

CREATE TABLE IF NOT EXISTS `vinateria_la_gran_bodega`.`Empleados` (
...
CREATE TABLE IF NOT EXISTS `vinateria_la_gran_bodega`.`Ventas` (
  ...
  CONSTRAINT `idEmpleado`
    ...
    REFERENCES `vinateria_la_gran_bodega`.`Empleados` (`idEmpleado`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
;
...
CREATE TABLE IF NOT EXISTS `vinateria_la_gran_bodega`.`auditoria_empleados` (
