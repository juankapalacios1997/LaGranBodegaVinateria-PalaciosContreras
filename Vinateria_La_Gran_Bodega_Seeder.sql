...
INSERT INTO `vinateria_la_gran_bodega`.`Clientes`(`idCliente`,`nombre`,`apellido`,`edad`) VALUES (202,'Andrea','Aguilar',19);
...
INSERT INTO `vinateria_la_gran_bodega`.`Clientes`(`idCliente`,`nombre`,`apellido`,`edad`) VALUES (208,'Carlos','Palacios',27);

INSERT INTO `vinateria_la_gran_bodega`.`Ventas`(`idVenta`, `fecha`,`idCliente`) VALUES (1001,ObtenerFormatoFecha('11/05/2025'),201);
INSERT INTO `vinateria_la_gran_bodega`.`Ventas`(`idVenta`, `fecha`,`idCliente`) VALUES (1002,ObtenerFormatoFecha('12/05/2025'),201);
INSERT INTO `vinateria_la_gran_bodega`.`Ventas`(`idVenta`, `fecha`,`idCliente`) VALUES (1003,ObtenerFormatoFecha('24/05/2025'),202);
INSERT INTO `vinateria_la_gran_bodega`.`Ventas`(`idVenta`, `fecha`,`idCliente`) VALUES (1004,ObtenerFormatoFecha('11/05/2025'),203);
INSERT INTO `vinateria_la_gran_bodega`.`Ventas`(`idVenta`, `fecha`,`idCliente`) VALUES (1005,ObtenerFormatoFecha('25/05/2025'),204);
INSERT INTO `vinateria_la_gran_bodega`.`Ventas`(`idVenta`, `fecha`,`idCliente`) VALUES (1006,ObtenerFormatoFecha('20/05/2025'),206);
INSERT INTO `vinateria_la_gran_bodega`.`Ventas`(`idVenta`, `fecha`,`idCliente`) VALUES (1007,ObtenerFormatoFecha('17/05/2025'),206);
INSERT INTO `vinateria_la_gran_bodega`.`Ventas`(`idVenta`, `fecha`,`idCliente`) VALUES (1008,ObtenerFormatoFecha('02/05/2025'),206);
INSERT INTO `vinateria_la_gran_bodega`.`Ventas`(`idVenta`, `fecha`,`idCliente`) VALUES (1009,ObtenerFormatoFecha('01/04/2025'),207);
INSERT INTO `vinateria_la_gran_bodega`.`Ventas`(`idVenta`, `fecha`,`idCliente`) VALUES (1010,ObtenerFormatoFecha('11/05/2025'),207);
INSERT INTO `vinateria_la_gran_bodega`.`Ventas`(`idVenta`, `fecha`,`idCliente`) VALUES (1011,ObtenerFormatoFecha('22/05/2025'),208);
INSERT INTO `vinateria_la_gran_bodega`.`Ventas`(`idVenta`, `fecha`,`idCliente`) VALUES (1012,ObtenerFormatoFecha('25/05/2025'),208);
